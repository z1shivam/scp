...
int main() {
    ...
    printf("==========================================================\n");
    printf("FUZZY SET OPERATIONS: CARTESIAN PRODUCT & MAX-MIN COMPOSITION\n");
    printf("==========================================================\n");
    ...
    printf("2. Max-Min Composition of two Fuzzy Relations\n");
    ...
    if (choice == 1 || choice == 3) {
        ...
        if (choice == 3) {
            // For choice 3, continue with Max-Min Composition
            ...
            // Compute Max-Min Composition
            FuzzyRelation T = maxMinComposition(R, S);

            // Print the result
            printRelationMatrix(T, "T = R∘S (A×C)");
